...
internal static partial class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        if (args.Contains("--voice-routing"))
        {
            Task.Run(CheckVoiceRoutingAsync).GetAwaiter().GetResult();
                ...
                "--planner-live"))
        {
            ...
            Console.WriteLine(
                $"PASS: {_checks} native multi-step planner checks.");
        ...
        if (args.Contains("--uia-text"))
        {
            ...
            Console.WriteLine($"PASS: {_checks} UI text input checks.");
            return;
        }
